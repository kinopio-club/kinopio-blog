...
I occasionally got good feedback and discussions on 𝕏 (general audiences), Mastodon (technical), and on Posts.cv (designers). But I only ever got crickets on Bluesky, Instagram, Threads, and LinkedIn, so I probably won't use those [anymore](https://kinopio.club/mapping-digital-culture-6saR0HlgclTzPr4U9GCF2).
